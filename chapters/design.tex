...
\begin{enumerate}
    ...
    \item Compile and launch \textsc{Citadel}'s \textit{preparatory enclave}; this must be signed with the same \textit{signing identity} as any policy enclaves generated. This ingests the two keys and generates a sealed keyset to present presented to initialising enclaves.
