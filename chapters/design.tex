...
\paragraph{} As a final comment, it must be noted that SGX is not without its flaws; §~\ref{sec:sgx-vulnerabilities} discusses this and its impact on the project.
