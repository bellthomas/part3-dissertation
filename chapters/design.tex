...
\paragraph{} Building \textsc{Citadel} requires both the kernel and policy enclave to be in agreement about the RSA keys to be used; without this building will fail. A preparatory script achieves this by;
