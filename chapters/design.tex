...
int c_open(const char *pathname, int oflag, mode_t mode) {
    ...
    //    We close and reopen automatically to ensure it is independently tagged.
    ...
    // Request access from the policy enclave. Claims the file if not tagged.
